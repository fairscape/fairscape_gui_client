...
const NodeWrapper = styled.div<{
  ...
  background: #fff;
  color: #1a1a1a; /* dark node text — app theme defaults text to light, invisible on white nodes */
  padding: 0;
  border-radius: 5px;
...
const EvidenceNode: React.FC<NodeProps<EvidenceNodeData> & { className?: string }> = ({
  data,
  isConnectable,
