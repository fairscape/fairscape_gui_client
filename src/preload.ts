...
const api: FairscapeApi = {
  ...
  scanFiles: (dir) => ipcRenderer.invoke(CH.scanFiles, { dir }),
  createCrate: (dir, meta) => ipcRenderer.invoke(CH.createCrate, { dir, meta }),
  inferSchema: (dir, input) => ipcRenderer.invoke(CH.inferSchema, { dir, input }),
  setEntityProps: (dir, id, props) => ipcRenderer.invoke(CH.setEntityProps, { dir, id, props }),
  writeBuildState: (dir, update) => ipcRenderer.invoke(CH.writeBuildState, { dir, update }),
